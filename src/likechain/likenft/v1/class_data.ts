...
export const ClassData = {
  ...
  fromJSON(object: any): ClassData {
    ...
    if (object.blindBoxState !== undefined && object.blindBoxState !== null) {
      message.blindBoxState = BlindBoxState.fromJSON(object.blindBoxState);
    } else {
      message.blindBoxState = undefined;
    }
    return message;
  },
  ...
  toJSON(message: ClassData): unknown {
    ...
    message.config !== undefined &&
      (obj.config = message.config
        ...
        : undefined);
    message.blindBoxState !== undefined &&
      (obj.blindBoxState = message.blindBoxState
        ? BlindBoxState.toJSON(message.blindBoxState)
        : undefined);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ClassData>): ClassData {
    ...
    if (object.blindBoxState !== undefined && object.blindBoxState !== null) {
      message.blindBoxState = BlindBoxState.fromPartial(object.blindBoxState);
    } else {
      message.blindBoxState = undefined;
    }
    return message;
...
const baseBlindBoxState: object = {
...
export const BlindBoxState = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BlindBoxState {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseBlindBoxState } as BlindBoxState;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BlindBoxState {
    const message = { ...baseBlindBoxState } as BlindBoxState;
    if (object.contentCount !== undefined && object.contentCount !== null) {
      message.contentCount = Long.fromString(object.contentCount);
    } else {
      message.contentCount = Long.UZERO;
    }
  ...
  toJSON(message: BlindBoxState): unknown {
    const obj: any = {};
    message.contentCount !== undefined &&
      (obj.contentCount = (message.contentCount || Long.UZERO).toString());
  ...
  fromPartial(object: DeepPartial<BlindBoxState>): BlindBoxState {
    const message = { ...baseBlindBoxState } as BlindBoxState;
    if (object.contentCount !== undefined && object.contentCount !== null) {
      message.contentCount = object.contentCount as Long;
    } else {
      message.contentCount = Long.UZERO;
    }
    if (object.toBeRevealed !== undefined && object.toBeRevealed !== null) {
