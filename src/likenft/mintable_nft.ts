...
const baseMintableNFT: object = { classId: "", id: "" };

export const MintableNFT = {
  encode(
    message: MintableNFT,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MintableNFT {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMintableNFT } as MintableNFT;
  ...
  fromJSON(object: any): MintableNFT {
    const message = { ...baseMintableNFT } as MintableNFT;
  ...
  toJSON(message: MintableNFT): unknown {
    const obj: any = {};
  ...
  fromPartial(object: DeepPartial<MintableNFT>): MintableNFT {
    const message = { ...baseMintableNFT } as MintableNFT;
    if (object.classId !== undefined && object.classId !== null) {
